...
Assignment 1 must include a section titled **Reflection on the use of generative AI**. Include links to the relevant GenAI conversation or conversations, identify where using GenAI resulted in cognitive offloading, and identify where GenAI supported learning. This section is required, but it is not graded or otherwise taken into consideration and does not count towards the 1,000-word limit.
